...
target("infinicore_infer")
    ...
    add_installfiles("src/quantization/quantization.h", {prefixdir = "include/infinicore_infer"})
    add_installfiles("src/quantization/awq_gemm.hpp", {prefixdir = "include/infinicore_infer"})
target_end()
